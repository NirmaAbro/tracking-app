  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <header className="bg-white shadow-md px-6 py-4 flex justify-between items-center">
        <h1 className="text-xl sm:text-2xl font-bold text-blue-700">Driver Tracker Dashboard</h1>
      ...
      <main className="flex-1 p-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-md p-6 hover:shadow-xl transition-all">
            ...
            <p className="text-sm text-gray-500 mt-2">Track drivers and passengers in real-time.</p>
          </div>

          {/* Example Card 2 */}
          <div className="bg-white rounded-xl shadow-md p-6 hover:shadow-xl transition-all">
            <h2 className="text-lg font-semibold text-gray-700">Chat System</h2>
            <p className="text-sm text-gray-500 mt-2">Access personal chat between users.</p>
          </div>

          {/* Example Card 3 */}
          <div className="bg-white rounded-xl shadow-md p-6 hover:shadow-xl transition-all">
            <h2 className="text-lg font-semibold text-gray-700">User Profile</h2>
            <p className="text-sm text-gray-500 mt-2">View and update your account information.</p>
          </div>
        </div>
      </main>
    </div>
